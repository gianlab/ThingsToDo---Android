    ...
    public Cursor fetchAllAzioni(int Idcategoria,int IDpriorita) {
    	...
    	if (Idcategoria==MainActivity.CATEGORIES_ALL){
    		return mDb.query(DATABASE_TABLE_AZIONI, 
            		new String[] {KEY_ROWID,KEY_AZIONE,
            					  KEY_DATA,KEY_ID_PRIORITA,	
            					  KEY_ID_CATEGORIA
            					  }, KEY_ID_PRIORITA+"="+IDpriorita, null, null, null, KEY_DATA );
    		...
    		return mDb.query(DATABASE_TABLE_AZIONI, 
            		new String[] {KEY_ROWID,KEY_AZIONE,
            					  KEY_DATA,KEY_ID_PRIORITA,	
            					  KEY_ID_CATEGORIA
            					  }, KEY_ID_CATEGORIA+"="+Idcategoria, null, null, null, KEY_DATA );
        ...
        return mDb.query(DATABASE_TABLE_AZIONI, 
        		new String[] {KEY_ROWID,KEY_AZIONE,
				  				KEY_DATA,KEY_ID_PRIORITA,	
				  				KEY_ID_CATEGORIA  
				  			  }, KEY_ID_CATEGORIA + "=" + Idcategoria + " AND "+KEY_ID_PRIORITA+"="+IDpriorita, null, null, null, KEY_DATA );
    }
